...
alias run-test='run-any bundle exec rspec spec/factories/ spec/lib/ spec/presenters/ spec/services/ spec/views/ spec/models/ --fail-fast'
alias run-features='run-any bundle exec rspec spec/features/ --fail-fast'
